...
from datasets.datasets_utils.generalfunciton import add_noise
...
indexs = [1, 2, 3]  # 不考虑normal, in [1,9] | [3,6,9] | list(range(1,10))
lab_name = ['N'] + [lab_name[i] for i in indexs]
...
if __name__ == '__main__':
    root = r'E:\6-数据集\0-机械故障诊断数据集\1-凯斯西储大学数据'
